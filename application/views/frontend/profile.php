						...
						<div class="col-lg-6">
							...
							<div class="card" align="left">
								...
								<div class="card-body" align="left">
									<div class="row">
										<div class="col-sm-8">
											<h5 class="card-title">nomor kartu identitas</h5>
										...
										<div class="row">
											<div class="col-sm-14">
												<div class="row form-group">
													<label for="nama" class="control-label">nomor kartu identitas</label>
												...
												<div class="row form-group">
													<label for="nama" class="control-label">No TElpon</label>
