				...
				<div class="row">
					<div class="col-lg-4">
						...
						<div class="card mb-5">
							...
							<div class="card-body">
								<ul>
									<li>► Tujuan <b><?php echo $asal['kota_tujuan']." - ".$jadwal['kota_tujuan']." [".$jadwal['kd_jadwal']."]"; ?></b></li>
									<li>► Nama Bus  <b><?php echo $jadwal['nama_bus'];  ?></b></li>
									<li>► Nomor Bus  <b><?php echo $jadwal['plat_bus'];  ?></b></li>
									<li>► Keberangkatan <b><?php echo strtoupper($asal['kota_tujuan'])." - ".$asal['terminal_tujuan']; ?></b></li>
									<li>► Kedatangan <b><?php echo strtoupper($jadwal['kota_tujuan'])." - ".$jadwal['terminal_tujuan']; ?></b></li>
									<li>► Harga: <b>$<?php echo number_format((float)($jadwal['harga_jadwal']),0,",",".") ; ?></b></li>
									<li>► Tanggal Keberangkatan <b><?php echo nama_hari($tanggal).",".tgl_indo($tanggal) ?></b></li>
									<li>► Berangkat. Waktu <b>pada <?php echo $jadwal['jam_berangkat_jadwal']; ?></b></li>
									<li>► Jam kedatangan <b>pada <?php echo $jadwal['jam_tiba_jadwal']; ?> </b></li>
					...
					<div class="col-lg-4">
						<form action="<?php echo base_url('tiket/afterbeli') ?>" method="get">
							...
							<div class="card mb-5" >
								<div class="card-header">
									<i class="fas fa-bus"></i> Pemilihan Kursi
								</div>
								<center class="">
								<table class="">
									<tr>
									...
									<!-- Log on to codeastro.com for more projects -->
										...
										<tr>
											...
											<div class="col-lg-4">
												...
												<div class="card mb-5">
													<div class="card-header">
														<i class="fas fa-bookmark"></i> Konfirmasi pemesanan
													</div>
													<div class="alert alert-success" role="alert">
														<p>Setelah memilih kursi, silakan klik tombol 'Selanjutnya' untuk melanjutkan.</p>
														<div class='btn-group'>
