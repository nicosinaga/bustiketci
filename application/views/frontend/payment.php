					...
					<div class="col-lg-10">
						...
						<div class="card">
							...
							<div class="card-body" align="center">
								...
								<h6>Batas waktu pembayaran Anda akan berakhir</h6>
								...
								<div class="medium-title col-12 mb-20">
									<h4><p>Silahkan transfer pembayaran ke nomor rekening berikut</p></h4>
								</div>
								<div class="offset-lg-1 col-lg-10 offset-sm-0 col-sm-12">
									<div class="row">
										...
										<div class="col-md-3 copy-link">
											<button onclick="myFunction()" class="btn btn-outline-primary"><i class="fas fa-copy"></i> Salin No. Rekening</button>
										</div>
									</div>
								</div>
								<div class="col-12 medium-title regular-text mt-20">
									<h4><b> <p>Jumlah Total</p></b></h4>
								</div>
									...
									<div class="col-md-8 mt-sm-30">
										...
										<div class="">
											<ol class="ordered-list" align="left">
												<li>Masukkan <?= $tiket[0]['nama_bank']; ?> Kartu ATM</li>
												<li>Masukkan PIN ATM Anda</li>
												<li>Pilih Menu Transaksi Lainnya</li>
												<li>Pilih menu Transfer dan Ke Rekening <?= $tiket[0]['nama_bank']; ?></li>
												<li>Masukkan nomor rekening <?= $tiket[0]['nama_bank']; ?> yang ditujukan</li>
								...
								<a href="<?= base_url('tiket/konfirmasi/'.$tiket[0]['kd_order'].'/'.$total) ?>" class="btn btn-primary pull-center">Kirim untuk Konfirmasi Pembayaran </a>
							</div>
						</div>
					</div>
				</section>
