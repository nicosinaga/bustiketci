            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <p>Kota Tujuan :  <b><?= strtoupper($asal['kota_tujuan'])." - ".$asal['terminal_tujuan']; ?></b></p>
                  <p>Tujuan : <b><?= strtoupper($jadwal['kota_tujuan'])." - ".$jadwal['terminal_tujuan']; ?></b></p>
                  <p>Keberangkatan   : <b><?= date('H:i',strtotime($jadwal['jam_berangkat_jadwal'])) ?></b></p>
                  <p>Kedatangan : <b><?= date('H:i',strtotime($jadwal['jam_tiba_jadwal'])) ?></b></p>
